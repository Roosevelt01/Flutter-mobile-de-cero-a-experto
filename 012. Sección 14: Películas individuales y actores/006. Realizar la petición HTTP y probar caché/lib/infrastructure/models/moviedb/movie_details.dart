class MovieDetails {
    ...
    final BelongsToCollection? belongsToCollection; // Se agrega ? para indicar que puede ser nulo
    final int budget;
    ...
    factory MovieDetails.fromJson(Map<String, dynamic> json) => MovieDetails(
        adult: json["adult"],
        backdropPath: json["backdrop_path"] ?? '', // Se agregar ?? '' para manejar posibles valores nulos
    ...
    Map<String, dynamic> toJson() => {
        ...
        "belongs_to_collection": belongsToCollection?.toJson(), // Se agrega ? para manejar posibles valores nulos
        "budget": budget,
...
class BelongsToCollection {
    final int id;
    final String name;
    final String ? posterPath; // Se agrega ? para indicar que puede ser nulo
    final String backdropPath;
