...
//Paso 1.1: Se define la clase `ThemeNotifier` que extiende `StateNotifier<AppTheme>`.
...
//Paso 1.2: Se define un `StateNotifierProvider` que crea una instancia de `ThemeNotifier`.
