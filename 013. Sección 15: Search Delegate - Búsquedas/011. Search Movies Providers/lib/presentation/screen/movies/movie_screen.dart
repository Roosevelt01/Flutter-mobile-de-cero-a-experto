            ...
            SizedBox.expand( 
                child: Image.network( 
                  ...
                  loadingBuilder: (context, child, loadingProgress) { 
                    ...
                    return FadeIn(child: child); //Paso 2.1: Usar FadeIn de animate_do para una transicion suave
                  },
                ),
            ), 
          ...
          return Container(
            ...
            child: Column(
              ...
              children: [
                ...
                FadeInRight(//Paso 3.1: Usar FadeIn de animate_do para una transicion suave
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                    child: Image.network(
                      actor.profilePath, 
